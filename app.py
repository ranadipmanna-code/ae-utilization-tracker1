...
#
#     Mine            Anudip orange   (the brand colour marks *your* work)
#     Open/Available  blue
#     Teammate's      green
#     Mock Interview  violet
#
# Mock Interview moved off orange precisely because orange is now the brand
# accent; leaving it there would have made "mine" and "MI" indistinguishable.
# The Calendar's "project" type took over the old teal in exchange.
# ---------------------------------------------------------------------------
THEMES = {
    # Warm paper white, navy ink, Anudip orange accent.
    "light": {
        ...
        "accent": BRAND["orange"], "accent_soft": "#fdf0e6",
        # Anudip orange is a mid-tone: WHITE on it is only 2.9:1, which fails
        # WCAG. Navy on orange is 5.1:1 and is the pairing the brand already
        # uses. `accent_text` is a darkened orange for when the accent has to
        # BE the text on a pale surface (5.4:1 on white).
        "on_accent": BRAND["navy"], "accent_text": "#ad4f0f",
        ...
        "proj_bg": "#e9f6f4", "proj_border": "#0d9488", "proj_text": "#0a5952",
    ...
    # orange still reads as the brand colour and not as a warning.
    "dark": {
        "bg": BRAND["navy_deep"], "surface": "#15202c", "surface_2": "#1b2836",
        "text": "#e9eef4", "muted": "#90a2b6", "border": "#263543",
        "accent": BRAND["orange_lite"], "accent_soft": "#2b1c10",
        # On the dark canvas the lighter orange already clears AA as text
        # (7.1:1), so accent_text is just the accent.
        "on_accent": "#2b1405", "accent_text": BRAND["orange_lite"],
        ...
        "proj_bg": "#0d2422", "proj_border": "#2fb3a5", "proj_text": "#8fddd4",
...
def login_view():
    ...
    with mid:
        ...
        st.markdown(
            ...
            '<div class="bb-mark"><img src="data:image/png;base64," alt="Anudip Foundation"/></div>'
