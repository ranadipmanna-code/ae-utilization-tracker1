...
EXTENDED_AES = {
    # CMIS-exact addresses — must stay in sync with seed_appdb.py::EXTENDED_AE.
    # If these drift, Extended AEs get written into core_ae_faculty_map as if
    # they were ordinary trainers, double-counting them against their Core AE.
    "priyanka_roy@anudip.org", "shanmukh.addala@anudip.org", "kundan.sinha@anudip.org",
    "sabreena.ramzan@anudip.org", "divya.s@anudip.org", "pallav.punit@anudip.org",
    "aniruddha.sharma@anudip.org", "mahalakshmi.grk@anudip.org", "dipankar.biswas@anudip.org",
    "aarti.kumari@anudip.org", "pranjya.dash@anudip.org", "pulak@anudip.org",
    "priyanka.nongkhlaw@anudip.org",
    # Legacy spellings kept so a stale alignment file still excludes them.
    "priyanka.roy@anudip.org", "shanmukh.adala@anudip.org", "divya.ns@anudip.org",
    "anirudhha.sharma@anudip.org", "grk.mahalakshmi@anudip.org",
    "pranjya.das@anudip.org", "pulak.bhattacharya@anudip.org",
}
