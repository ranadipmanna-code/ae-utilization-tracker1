...
def _css(t: dict, name: str = "light") -> str:
    ...
    <style>
      ...
      .pill-mi    {{ background:{t['mock_border']}; color:#fff; }}
      .locked-status {{
